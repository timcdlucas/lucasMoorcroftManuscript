...
To work through one example that contains both $\theta$ and $\alpha$ we will examine model SE2. All other derivations are described in S1 with computer algebra scripts in S2. 
\begin{figure}[t]
        \centering
