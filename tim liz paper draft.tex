...
\begin{figure}[t]
        ...
        \begin{subfigure}[t]{0.5\textwidth}
                \centering
		\includegraphics[width=1\textwidth]{imgs/ResultsTimeSubsample.pdf}
                \caption{Time}
                \label{f:Time}
        \end{subfigure}
        ~ 
		...
		\includegraphics[width=1\textwidth]{imgs/ResultsDensitySubsample.pdf}
                ...
                \label{f:Density}
        \end{subfigure}
	\caption{Discrepency between known simulation density and estimated density with increasing survey time (A) and animal density (B) with 95\% confidence intervals. As survey time or animal density increases, precision of the estimate increases. However, the accuracy, or systematic bias, appears to be zero.}
	\label{}
\end{figure}
