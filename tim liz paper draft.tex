...
The average distance travelled by an animal within the survey has no significant impact on the accuracy of the model, but the precision of the estimator will increase with the distance travelled by the animal, Figure~\ref{f:Distance}. The standard deviation for the error falls below five when the average distance moved per animal is greater than 40km, 55km, 25km and 25km for models p141, p343, p221, and p322 respectively. 
