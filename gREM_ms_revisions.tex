...
Occupancy modelling may be another methodology available where individuals cannot be told part. There have been a number of extensions to the basic model \citep{bailey2013advances}, including methods which estimate absolute abundance \citep{royle2003estimating}. Occupancy models can be quite complex, make number of important assumptions that could bias results, and require careful study design \citep{bailey2013advances}. Whilst these methods would be suited to a well-understood system, inappropriate model choices or study design can affect the robustness of the study \citep{royle2003estimating}. The gREM has the advantage of being simple and easily understood, relative to these occupancy models, not requiring the use of Bayesian methodology or the choice of statistical distributions for encounter rates. We feel that the gREM therefore would be the most appropriate choice in many study areas. 
