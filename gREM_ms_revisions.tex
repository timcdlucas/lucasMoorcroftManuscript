...
The measurement of parameters is taxon dependant although there are many commonalities. . Call directionality has been though the measurements are rarely of $\alpha$ exactly.  
%However it should be noted that under live survey conditions, where there is uncertainty and natural variation around animal speeds, call and signal widths, it may take more captures to reach this level of precision.  

% While estimates are needed, model not too sensitive
% 
% need to be carefuil with all
%
% alpha is most sensitive, should be careful. Different across parameters
% Not important for camera trap.
% practical holdereid
...
%though it is expected that nonlinear movement will increase variance \citep{Hutchinson_Waser_2007} and this might be evident given other simulation setups. Furthermore, these movement models are still simple representations of true animal movement which are dependent on multiple factors such as behavioural state and existence of home ranges \citep{smouse2010stochastic}. 
