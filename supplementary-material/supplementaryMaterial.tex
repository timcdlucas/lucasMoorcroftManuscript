...
$\alpha$	& Animal call/beam width & \SI{}{\radian} \\
...
\end{tabular}
\caption{List of symbols used to describe the gREM and simulations}
\label{t:paras}
\end{table}
...
These supplementary methods derives all the models used in the paper. For continuity, the gas model derivation is included here as well as in the main text. The calculation of all integrals is included in the Python script S3. 
